...
patterns <- yaml::read_yaml("C:/Users/dominnic/OneDrive - Ascensus/Documents/Projects/AlignAI/signal_patterns.yml")
...
tasks_df <- read.csv("C:/Users/dominnic/OneDrive - Ascensus/Documents/Projects/AlignAI/data/examples/loan_request_sop_tasks.csv",
